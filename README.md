...
Сейчас реализовано: регистрация, логин, защищённые роуты, выход — минимальный скелет, на который лягут следующие шаги (каталог планов и покупка, просмотр подписки, флоу отмены, баланс баллов лояльности, admin-панель).
